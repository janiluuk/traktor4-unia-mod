...
*/
    ...
    Item {
        ...
        anchors.leftMargin: browserAlbum.value ? 3 : 5
        ...
        height: browserRows.value > 5 ? browser.itemHeight : (browser.itemHeight/2 + 3)
        ...
        Widgets.ScrollingTextBrowser {
            ...
            textFontSize: artistField.visible ? 14 : fonts.middleFontSize
    ...
    Text {
        ...
        elide: Text.ElideRight
        visible: browserRows.value <= 5 && browserArtist.value
        opacity: model.prevPlayed && showTracksPlayedDarker.value ? 0.25 : 1
    }

    //BPM
    //property double bpmOffset: (((model.bpm.toFixed(2)-clockBpm.value)/clockBpm.value)-1)*100
    Text {
        id: bpmField
    ...
    Text {
        ...
        anchors.rightMargin: browserRating.value ? 5 : 3
        anchors.verticalCenter: parent.verticalCenter
        width: 30
        visible: browserKey.value
        clip: true

        text: model.dataType == BrowserDataType.Track ? (((model.key == "none") || (model.key == "None")) ? "" : (displayCamelotKey.value ? Key.toCamelot(model.key): model.key)) : ""
          ...
          */
          ...
          case 6: //Generic folder
              switch (parentPath) {
                  ...
                  case "Browser | Beatport Streaming":
                  case "Browser | Beatsource Streaming":
                  // TODO: Delete the following 2 Browser cases when Streaming nodes have been fixed...
                  case "Browser | ":
                  case "Browser":
                      ...
                      switch (node) {
                          ...
                          case "Curated Playlists":
                              if (parentPath.endsWith("Beatport Streaming")) return "../../../Shared/Images/Browser/Icons/BeatsourceLINK.png"
                              else if (parentPath.endsWith("Beatsource Streaming")) return "../../../Shared/Images/Browser/Icons/BeatsourceLINK.png"
                              else return "../../../Shared/Images/Browser/Icons/Folder.png"
                          case "My Playlists":
                              return "../../../Shared/Images/Browser/Icons/Favorites.png"
                          case "Top 100":
                  ...
                  case "Browser | Beatport Streaming | Curated Playlists":
                  case "Browser | Beatsource Streaming | Curated Playlists":
                      return "../../../Shared/Images/Browser/Icons/Genres.png"
          ...
          case 8: //Generic Playlist
              switch (parentPath) {
                  case "Browser | Beatsource Streaming | Genres":
                  case "Browser | Beatsource Streaming | Top 100":
                  case "Browser | Beatsource Streaming | Curated Playlists":
                      return "../../../Shared/Images/Browser/Icons/Genres.png"
                  default:
                      return "../../../Shared/Images/Browser/Icons/Playlist.png"
          ...
          case 0:
              ...
              */
              return "../../../Shared/Images/Browser/Icons/Search.png"
          default:
              return "../../../Shared/Images/Browser/Icons/Folder.png"
      }
  }
