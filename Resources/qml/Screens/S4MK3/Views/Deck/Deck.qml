...
import '../Themes/OriginalPro' as OriginalPro
...
//------------------------------------------------------------------------------------------------------------------
    ...
    AppProperty { id: advancedPanel; path: "app.traktor.decks." + deckId + ".deck.select_advanced_panel" } //0: Hotcues, 1: Loop, 2: Grid
        ...
        Component {
            ...
            Item {
                ...
                Loader {
                    id: themeLoader
                    anchors.fill: parent
                    sourceComponent: theme.value <= 1 ? originalProDeck : uniaDeck
                }
                Component {
                    id: originalProDeck
                    OriginalPro.TrackDeck  {
                        id: trackDeck
                        deckId: deck.deckId
                    }
                }
        ...
        Component {
            ...
            Item {
                ...
                Loader {
                    ...
                    anchors.fill: parent
                    //sourceComponent: theme.value <= 1 ? originalProDeck : uniaDeck
                    sourceComponent: originalProDeck
                }
                Component {
                    id: originalProDeck
                    OriginalPro.RemixDeck {
                        id: remixDeck
                        deckId: deck.deckId
                    }
                }
