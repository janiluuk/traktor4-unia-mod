...
Rectangle {
  ...
  AppProperty { id: fxType; path: "app.traktor.fx." + fxUnit + ".type" }

  readonly property bool isUpperDeck: footerId < 3
  readonly property bool isTraktorS5: screen.flavor == ScreenFlavor.S5

  property color fxUnitColor: fxType.value != FxType.PatternPlayer ? colors.colorIndicatorLevelOrange : colors.fxPatternPlayer
  property color levelColor: contentState == "FX" ? fxUnitColor : (contentState == "MIDI" ? (screen.focusedDeckId < 3 ? colors.brightBlue : colors.colorWhite) : (isUpperDeck ? colors.brightBlue : colors.colorWhite))
  property color backgroundColor: contentState == "FX" ? (fxType.value != FxType.PatternPlayer ? colors.orangeDimmed : colors.darkerColor(colors.fxPatternPlayer, 0.15)): (contentState == "MIDI" ? colors.colorGrey16 : (isUpperDeck ? colors.footerBlue : colors.colorGrey40))
...
//----------------------------------------------------------------------------------------------------------------------
  ...
  Rectangle {
    ...
    color: fxOnA.value == 1 ? fxUnitColor : colors.colorBlack
  ...
  Rectangle {
    ...
    color: fxOnB.value == 1 ? fxUnitColor : colors.colorBlack
    visible: contentState == "FX" && sizeState == "large" // preferences.displayAssignFX
    anchors.right: parent.right
    ...
    color: fxOnC.value == 1 ? fxUnitColor : colors.colorBlack
    visible: contentState == "FX" && sizeState == "large" // preferences.displayAssignFX
    anchors.left: parent.left
    ...
    color: fxOnD.value == 1 ? fxUnitColor : colors.colorBlack
    visible: contentState == "FX" && sizeState == "large" // preferences.displayAssignFX
    anchors.right: parent.right
