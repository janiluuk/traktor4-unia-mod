...
Item {
  ...
  property color fxUnitBackgroundColor: fxType.value != FxType.PatternPlayer ? colors.orangeDimmed : colors.darkerColor(colors.fxPatternPlayer, 0.15)

  height: 84 // includes darker panel and black border with shadow at the bottom
  anchors.left:  parent.left
  anchors.right: parent.right

  AppProperty { id: fxType; path: "app.traktor.fx." + fxUnit + ".type" } // singleMode -> fxSelect1.description else "DRY/WET"
  ...
  Rectangle {
    ...
    Row {
      TopInfoDetails {
        ...
        parameter: fxDryWet
        isOn: fxOn.value
        label: fxType.value == FxType.Single ? fxSelect1.description : fxType.value == FxType.Group ? "DRY/WET" : "VOLUME"
        buttonLabel: fxType.value != FxType.Group ? "ON" : ""
        fxEnabled: fxType.value == FxType.Single || fxSelect1.value
        barBgColor: "black"
      }
      ...
      TopInfoDetails {
        ...
        fxEnabled: (fxSelect1.value || (fxType.value == FxType.Single && fxSelect1.value) )
        barBgColor: "black"
      }
      ...
      TopInfoDetails {
        ...
        fxEnabled: (fxSelect2.value || (fxType.value == FxType.Single && fxSelect1.value) )
        barBgColor: "black"
      }
      ...
      TopInfoDetails {
        ...
        fxEnabled: (fxSelect3.value || (fxType.value == FxType.Single && fxSelect1.value) )
        barBgColor: "black"
      }
    }
  }
  ...
  Rectangle {
    ...
    width:	   parent.width
    color:	   fxUnitColor //colors.colorBlack
    height:	  1
  }
  Rectangle {
    id: headerShadow
...
//----------------------------------------------------------------------------------------------------------------------
  ...
  Rectangle {
    ...
    color: fxOnA.value ? fxUnitColor : colors.colorBlack
    anchors.left: parent.left
  ...
  Rectangle {
    ...
    color: fxOnB.value ? fxUnitColor : colors.colorBlack
    anchors.right: parent.right
  ...
  Rectangle {
    ...
    color: fxOnC.value ? fxUnitColor : colors.colorBlack
    anchors.left: parent.left
  ...
  Rectangle {
    ...
    color: fxOnD.value ? fxUnitColor : colors.colorBlack
    anchors.right: parent.right
