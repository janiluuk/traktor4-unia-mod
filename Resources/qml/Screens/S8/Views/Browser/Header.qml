...
Rectangle {
    ...
    property string versionName: (root.value).split(((root.value).indexOf(":\\") == 1 || (root.value).startsWith("/")) ? "/" : ":").find(node => /Traktor \d\.\d/.test(node)) || ""
...
//--------------------------------------------------------------------------------------------------------------------
    ...
    Text {
        ...
        text: versionName ?  versionName.replace(/Traktor/i, "Traktor Pro") : "Traktor Pro"
