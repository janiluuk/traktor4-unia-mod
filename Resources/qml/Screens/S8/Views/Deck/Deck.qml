...
import '../Themes/Unia' as Unia
import '../Themes/UniaMod' as UniaMod
        ...
        Component {
            ...
            Item {
                ...
                Loader {
                    id: themeLoader
                    anchors.fill: parent
                    sourceComponent: theme.value == 1 ? traktorDeck : (theme.value == 2 ? uniaDeck : (theme.value == 3 ? uniaModDeck : (theme.value == 4 ? primeDeck : (theme.value == 5 ? cdj2000Deck : cdj3000Deck))))
                }
                Component {
                    id: traktorDeck
                    Traktor.TrackDeck  {
        ...
        Component {
            ...
            Item {
                ...
                Loader {
                    id: themeLoader
                    anchors.fill: parent
                    sourceComponent: theme.value == 1 ? traktorDeck : (theme.value == 2 ? uniaDeck : (theme.value == 3 || theme.value == 4 ? uniaModDeck : (theme.value == 5 ? cdj2000Deck : cdj3000Deck)))
                }
                Component {
                    id: traktorDeck
                    Traktor.RemixDeck {
        ...
        Component {
            ...
            Item {
                ...
                Loader {
                    id: themeLoader
                    anchors.fill: parent
                    sourceComponent: theme.value == 1 ? traktorDeck : (theme.value == 2 ? uniaDeck : uniaModDeck) //(theme.value == 3 ? uniaModDeck : (theme.value == 4 ? primeDeck : (theme.value == 5 ? cdj2000Deck : cdj3000Deck))))
                }
                Component {
                    id: traktorDeck
                    Traktor.LiveDeck {
        ...
        Component {
            ...
            Item {
                ...
                Loader {
                    id: themeLoader
                    anchors.fill: parent
                    sourceComponent: theme.value == 1 ? traktorDeck : uniaModDeck
                }
                Component {
                    id: traktorDeck
                    Traktor.ThruDeck {
