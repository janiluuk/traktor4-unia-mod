...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Widgets.KeySyncBox {
    ...
    height: 20
    width: 68
    visible: deckSize != "small" && masterId.value != -1 && isLoaded.value && keyLock.value
  }
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Widgets.BeatCounter {
    ...
    anchors.topMargin: 36
    anchors.horizontalCenter: parent.horizontalCenter
    visible: deckSize != "small" && !beatmatchPracticeMode.value && isLoaded.value && (phaseWidget.value == 2 || (phaseWidget.value == 3 && (masterDeckType.value == DeckType.Remix || masterId.value == -1)))
  ...
  Item {
    ...
    anchors.left: parent.left
    anchors.right: parent.right
    visible: deckSize != "small" && !beatmatchPracticeMode.value && !isMaster && masterId.value != -1 && phaseWidget.value == 3 && (masterDeckType.value == DeckType.Track || masterDeckType.value == DeckType.Stem)
    ...
    Widgets.WaveformBeatCounter{
        ...
        masterColor: deckColors[masterId.value + 1]
        masterLetter: true
    }
  }
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  WF.WaveformContainer {
    ...
    anchors.top: deck_header_line.bottom
    anchors.topMargin: isInEditMode ? 5 : ((phaseWidget.value == 0 || (phaseWidget.value == 3 && isMaster)) ? 30 : 70)
