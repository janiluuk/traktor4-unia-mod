...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Rectangle {
    ...
    width: parent.width
    height: 20
    color: brightMode.value ? colors.colorGrey128 : colors.darkerColor(colors.pioneerRed, 0.5)
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Item {
    ...
    Text {
        ...
        color: "white" //brightMode.value ? colors.colorGrey32 : colors.colorGrey232
