...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Widgets.ArtworkBox {
    ...
    albumBorderWidth: 5
    albumBorderColor: deck_header.color
  }
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Item {
    ...
    anchors.bottom: deck_header.bottom
    anchors.left: topLeftCorner.value == 0 ? parent.left : artwork_box.right
    anchors.leftMargin: topLeftCorner.value == 0 ? 5 : 0
    ...
    Text {
        ...
        anchors.top: parent.top
        anchors.topMargin: 20
        anchors.left: lengthField.right
        anchors.leftMargin: 20
        visible: isLoaded.value

        text: trackBpm.value.toFixed(1)
        color: "white"
        font.family: "Pragmatica" // is monospaced
        font.pixelSize: fonts.middleFontSize
    }
    ...
    Text {
        ...
        anchors.top: parent.top
        anchors.topMargin: 20
        anchors.left: headerBpmField.right
        anchors.leftMargin: 20
        visible: isLoaded.value
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Text {
    ...
    visible: deckSize != "small" //and when counting backwards
    color: "white"
...
/*
  Item {
    ...
    anchors.leftMargin: 5
    width: 50
    visible: isQuantizeEnabled.value
    ...
    Text {
        ...
        horizontalAlignment: Text.AlignHCenter
        text: "QUANTIZE"
        color: isQuantizeEnabled.value ? colors.red : colors.colorGrey72 //"white"
        font.pixelSize: fonts.scale(10)
    }
    ...
    Rectangle {
        ...
        color: "transparent"
        border.width: 1
        border.color: isQuantizeEnabled.value ? colors.red : colors.colorGrey72
        radius: 1
        //antialiasing: false
        ...
        Text {
            ...
            verticalAlignment:   Text.AlignVCenter
            text: "1"
            color: isQuantizeEnabled.value ? colors.red : colors.colorGrey72
            font.pixelSize: fonts.smallFontSize
        }
    }
  }
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Stripe.StripeContainer {
    ...
    anchors.left: loopField.right //quantizeField.right
    anchors.right: key_box.left
    anchors.bottom: parent.bottom //performancePanel.top
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Rectangle {
    ...
    radius: 1
    border.width: 1
    border.color: keyLock.value ? (masterId.value != -1 && isKeySynchronized ? colors.cyan : colors.red) : colors.colorGrey72
    visible: deckSize != "small"
    ...
    Text {
        ...
        horizontalAlignment: Text.AlignHCenter
        verticalAlignment: Text.AlignVCenter
        text: keyLock.value && masterId.value != -1 && isKeySynchronized ? "K.SYNC" : "MT"
  ...
  Text {
    ...
    anchors.topMargin: 1
    anchors.bottom: stripe_box.bottom
    anchors.left: stripe_box.right
    anchors.right: parent.right
    horizontalAlignment: Text.AlignHCenter
    text: isLoaded.value ? resultingKeyText : "-"
    font.pixelSize: 18
    color: isLoaded.value && keyLock.value && masterId.value != -1 && isKeySynchronized ? colors.pioneerGreen : "white"
  }
