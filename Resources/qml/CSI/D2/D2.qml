...
//------------------------------------------------------------------------------------------------------------------
    ...
    MappingPropertyDescriptor { id: onBrightness; path: "mapping.settings.led_on_brightness"; type: MappingPropertyDescriptor.Integer; value: 100; min: 50; max: 100 }
    MappingPropertyDescriptor { id: dimmedBrightness; path: "mapping.settings.led_dimmed_percentage"; type: MappingPropertyDescriptor.Integer; value: 25; min: 0; max: 50  }
    DirectPropertyAdapter { name: "LEDBrightnessOn"; path: onBrightness.path; input: false }
    DirectPropertyAdapter { name: "LEDDimmedPercentage"; path: dimmedBrightness.path; input: false }
    ...
    //Decks Assignment
    MappingPropertyDescriptor { id: decks; path: "mapping.settings.decks_assignment"; type: MappingPropertyDescriptor.Integer; value: DecksAssignment.AC }
...
//------------------------------------------------------------------------------------------------------------------
    ...
    Wire { from: "surface.shift"; to: DirectPropertyAdapter { path: globalShift.path } }

    //D2 ONLY
    MappingPropertyDescriptor { id: d2buttons; path: "mapping.settings.d2buttons"; type: MappingPropertyDescriptor.Integer; value: 0; min: 0; max: 2 } //0: Active Deck, 1: Top FX Unit, 2: Assigned decks to Top FX Unit
    //MappingPropertyDescriptor { id: d2buttonsShifted; path: "mapping.settings.d2buttonsShifted"; type: MappingPropertyDescriptor.Integer; value: 0; min: 0; max: 2 } //0: Active Deck, 1: Top FX Unit, 2: Assigned decks to Top FX Unit
    MappingPropertyDescriptor { id: d2buttonsShifted; path: "mapping.settings.d2buttonsShifted"; type: MappingPropertyDescriptor.Boolean; value: false }
    ...
    //Encoders
    MappingPropertyDescriptor { id: browseEncoder; path: "mapping.settings.browseEncoder"; type: MappingPropertyDescriptor.Integer; value: 0; min: 0; max: 6 } //0: BPM, 1: Tempo, 2: Controller Zoom, 3: TP3 Zoom, 4: Move, 5: Move 1 beat, 6: MixerFX adjust
    MappingPropertyDescriptor { id: shiftBrowsePush; path: "mapping.settings.shiftBrowsePush"; type: MappingPropertyDescriptor.Integer; value: 0; min: 0; max: 4 } //0: Disabled, 1: Instant Doubles, 2: Load Next Track, 3: Load Previous Track, 4: MixerFX On/Off
    MappingPropertyDescriptor { id: shiftBrowseEncoder; path: "mapping.settings.shiftBrowseEncoder"; type: MappingPropertyDescriptor.Integer; value: 1; min: 0; max: 6 } //0: BPM, 1: Tempo, 2: Controller Zoom, 3: TP3 Zoom, 4: Move, 5: Move 1 beat, 6: MixerFX adjust
    ...
    //Pads - Mode Selector
    MappingPropertyDescriptor { id: loopButton; path: "mapping.settings.loopButton"; type: MappingPropertyDescriptor.Integer; value: 0; min: 0; max: 2 }
    MappingPropertyDescriptor { id: shiftLoopButton; path: "mapping.settings.shiftLoopButton"; type: MappingPropertyDescriptor.Integer; value: 0; min: 0; max: 2 }
...
//------------------------------------------------------------------------------------------------------------------
    ...
    MappingPropertyDescriptor { id: topLeftCorner; path: "mapping.settings.topLeftCorner"; type: MappingPropertyDescriptor.Integer; value: 1; min: 0; max: 3 } //0: None, 1: Cover, 2: Letter, 3: Number
...
//------------------------------------------------------------------------------------------------------------------
    ...
    D2Side {
        id: side
        name: "side"
        decksAssignment: decks.value
        topDeckId: getTopDeckId(decks.value)
        bottomDeckId: getBottomDeckId(decks.value)
        surface: "surface"
        settingsPath: "mapping.settings"
        propertiesPath: "mapping.state"
        shift: globalShift.value
    }
    ...
    onRunningChanged: {
        console.log("D2 Running: " + running)
        if (running) {
            side.initializeModule();
...
//------------------------------------------------------------------------------------------------------------------
    ...
    MappingPropertyDescriptor { id: leftFocusedDeckId; path: "mapping.state.leftFocusedDeckId"; type: MappingPropertyDescriptor.Integer; value: masterId.value + 1 }
    MappingPropertyDescriptor { id: rightFocusedDeckId; path: "mapping.state.rightFocusedDeckId"; type: MappingPropertyDescriptor.Integer; value: masterId.value + 1 }

    property bool d2ScreenViewValue: side.screenView
    onD2ScreenViewValueChanged: {
        //TODO: Communicate between different pieces of hardware through Traktor?
