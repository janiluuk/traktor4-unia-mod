    ...
    WiresGroup {
        ...
        WiresGroup {
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.fx.buttons.3"; to: SetPropertyAdapter { path: fxSettingsTab.path; value: 3 } enabled: fxType.value == FxType.Group }
                Wire { from: "%surface%.fx.buttons.4"; to: SetPropertyAdapter { path: fxSettingsTab.path; value: 4 } enabled: fxType.value == FxType.Group }
            }
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.fx.buttons.3"; to: SetPropertyAdapter { path: fxSettingsTab.path; value: 7 } enabled: bottomFXUnit.value != 0 && fxType.value == FxType.Group }
                Wire { from: "%surface%.fx.buttons.4"; to: SetPropertyAdapter { path: fxSettingsTab.path; value: 8 } enabled: bottomFXUnit.value != 0 && fxType.value == FxType.Group }
            }
        }
        ...
        WiresGroup {
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.fx.buttons.1"; to: "fx1.enabled"; enabled: fxType.value != FxType.Group }
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.fx.buttons.1"; to: "fx2.enabled"; enabled: fxType.value != FxType.Group }
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.fx.buttons.1"; to: "fx3.enabled"; enabled: fxType.value != FxType.Group }
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.fx.buttons.1"; to: "fx4.enabled"; enabled: fxType.value != FxType.Group }
        ...
        WiresGroup {
            ...
            Wire { from: "fxOverlay.output"; to: DirectPropertyAdapter { path: topPanel.path } }
