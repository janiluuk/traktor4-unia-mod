...
Module {
    ...
    WiresGroup {
        ...
        WiresGroup {
            ...
            //Hotcue Mode
            Wire { from: "%surface%.hotcue"; to: SetPropertyAdapter { path: (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) ? activePadsMode.path : ""; value: PadsMode.hotcues; color: LED.legacy(safeDeckId) } enabled: (typeof hasTrackProperties !== 'undefined' && hasTrackProperties) && (typeof shift === 'undefined' || !shift) && (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) }
            Wire { from: "%surface%.hotcue"; to: SetPropertyAdapter { path: (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) ? activePadsMode.path : ""; value: PadsMode.tonePlay; color: LED.legacy(safeDeckId) } enabled: (typeof hasTrackProperties !== 'undefined' && hasTrackProperties) && (typeof shift !== 'undefined' && shift) && (typeof shiftHotcueButton !== 'undefined' && shiftHotcueButton && shiftHotcueButton.value == 3) && (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) }

            //Loop Modes
            Wire { from: "%surface%.hotcue"; to: SetPropertyAdapter { path: (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) ? activePadsMode.path : ""; value: PadsMode.loop; color: LED.legacy(safeDeckId) } enabled: (typeof hasDeckProperties !== 'undefined' && hasDeckProperties) && (typeof shift !== 'undefined' && shift) && (typeof shiftHotcueButton !== 'undefined' && shiftHotcueButton && shiftHotcueButton.value == 0) && (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) }
            Wire { from: "%surface%.hotcue"; to: SetPropertyAdapter { path: (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) ? activePadsMode.path : ""; value: PadsMode.advancedLoop; color: LED.legacy(safeDeckId) } enabled: (typeof hasDeckProperties !== 'undefined' && hasDeckProperties) && (typeof shift !== 'undefined' && shift) && (typeof shiftHotcueButton !== 'undefined' && shiftHotcueButton && shiftHotcueButton.value == 1) && (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) }
            Wire { from: "%surface%.hotcue"; to: SetPropertyAdapter { path: (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) ? activePadsMode.path : ""; value: PadsMode.loopRoll; color: LED.legacy(safeDeckId) } enabled: (typeof hasDeckProperties !== 'undefined' && hasDeckProperties) && (typeof shift !== 'undefined' && shift) && (typeof shiftHotcueButton !== 'undefined' && shiftHotcueButton && shiftHotcueButton.value == 2) && (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) }

            //Freeze Button
            Wire { from: "%surface%.freeze"; to: "FreezeButton"; enabled: (typeof shift === 'undefined' || !shift) && ((typeof hasDeckProperties !== 'undefined' && hasDeckProperties) && (typeof padsMode !== 'undefined' && padsMode && padsMode.value != PadsMode.freeze) && (typeof freezeButton !== 'undefined' && freezeButton && freezeButton.value == 0)) || ((typeof hasDeckProperties !== 'undefined' && hasDeckProperties) && (typeof padsMode !== 'undefined' && padsMode && padsMode.value == PadsMode.freeze) && (typeof freezeButton !== 'undefined' && freezeButton && freezeButton.value == 0)) || (typeof freezeButton !== 'undefined' && freezeButton && freezeButton.value == 1) }
            WiresGroup {
            ...
            //Sequencer Mode
            Wire { from: "%surface%.remix"; to: SetPropertyAdapter { path: (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) ? activePadsMode.path : ""; value: PadsMode.sequencer; color: LED.legacy(safeDeckId) } enabled: (typeof shift !== 'undefined' && shift) && (typeof hasRemixProperties !== 'undefined' && hasRemixProperties) && (typeof activePadsMode !== 'undefined' && activePadsMode && activePadsMode.path) }
        }
        WiresGroup {
