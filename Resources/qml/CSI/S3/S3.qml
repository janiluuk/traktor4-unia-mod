...
//------------------------------------------------------------------------------------------------------------------
    ...
    S3Preferences { name: "preferences"; id: preferences }
    ...
    Wire { from: "s3.left.shift"; to: DirectPropertyAdapter { path: "mapping.state.shift" } enabled: globalShiftEnabled.value }
    Wire { from: "s3.right.shift"; to: DirectPropertyAdapter { path: "mapping.state.shift" } enabled: globalShiftEnabled.value }

    MappingPropertyDescriptor { id: leftShift; path: "mapping.state.left.shift"; type: MappingPropertyDescriptor.Boolean; value: false }
    Wire { from: "s3.left.shift"; to: DirectPropertyAdapter { path: "mapping.state.left.shift" } enabled: !globalShiftEnabled.value }
    ...
    Wire { from: "s3.right.shift"; to: DirectPropertyAdapter { path: "mapping.state.right.shift" } enabled: !globalShiftEnabled.value }
    ...
    MappingPropertyDescriptor { id: browsePush; path: "mapping.state.browsePush"; type: MappingPropertyDescriptor.Integer; value: preferences.browsePush; min: 0; max: 4 } //0: Load Track, 1: Instant Doubles, 2: Load Next Track, 3: Load Previous Track, 4: BPM/Tempo Reset
    MappingPropertyDescriptor { id: shiftBrowseEncoder; path: "mapping.state.shiftBrowseEncoder"; type: MappingPropertyDescriptor.Integer; value: preferences.shiftBrowseEncoder; min: 0; max: 3 } //0: BPM, 1: Tempo, 2: Waveform Zoom, 3: Tree Navigation
    MappingPropertyDescriptor { id: shiftBrowsePush; path: "mapping.state.shiftBrowsePush"; type: MappingPropertyDescriptor.Integer; value: preferences.shiftBrowsePush; min: 0; max: 4 } //0: Open/Collapse tree node, 1: Instant Doubles, 2: Load Next Track, 3: Load Previous Track, 4: BPM/Tempo Reset
...
//------------------------------------------------------------------------------------------------------------------
    ...
    onRunningChanged: {
        console.log("S3 Running: " + running)
        if (running) {
