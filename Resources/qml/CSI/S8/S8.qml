...
//------------------------------------------------------------------------------------------------------------------
    ...
    Wire { from: "s8.left.shift"; to: DirectPropertyAdapter { path: leftShift.path } }
    ...
    Wire { from: "s8.right.shift"; to: DirectPropertyAdapter { path: rightShift.path } }
...
//------------------------------------------------------------------------------------------------------------------
    ...
    onRunningChanged: {
        console.log("S8 Running: " + running)
        if (running) {
