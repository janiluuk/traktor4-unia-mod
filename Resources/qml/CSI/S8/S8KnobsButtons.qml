...
Module {
    ...
    AppProperty { id: fxType; path: "app.traktor.fx." + bottomFXUnit.value + ".type" }
...
*/
    ...
    WiresGroup {
            ...
            WiresGroup {
                ...
                WiresGroup {
                    ...
                    WiresGroup {
                        ...
                        Wire { from: "%surface%.buttons.1"; to: "fx1.enabled"; enabled: fxType.value != FxType.Group }
                    ...
                    WiresGroup {
                        ...
                        Wire { from: "%surface%.buttons.1"; to: "fx2.enabled"; enabled: fxType.value != FxType.Group }
                    ...
                    WiresGroup {
                        ...
                        Wire { from: "%surface%.buttons.1"; to: "fx3.enabled"; enabled: fxType.value != FxType.Group }
                    ...
                    WiresGroup {
                        ...
                        Wire { from: "%surface%.buttons.1"; to: "fx4.enabled"; enabled: fxType.value != FxType.Group }
        ...
        WiresGroup {
            ...
            Wire { from: "%surface%.buttons.3"; to: SetPropertyAdapter { path: fxSettingsTab.path; value: 7 } enabled: hasFXFooter.value && fxType.value == FxType.Group  }
            Wire { from: "%surface%.buttons.4"; to: SetPropertyAdapter { path: fxSettingsTab.path; value: 8 } enabled: hasFXFooter.value && fxType.value == FxType.Group  }
        }
    }
