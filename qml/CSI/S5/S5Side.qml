/*
 * Module: CSI/S5/S5Side.qml
 * Purpose: auto-documentation for TP4 S5 pack.
 */
import CSI 1.0
import QtQuick 2.0
...
//------------------------------------------------------------------------------------------------------------------
    ...
    function initializeModule() {
        ...
        if (!topFXUnit.value || !bottomFXUnit.value) {
            topFXUnit.value = topDeckId;
            bottomFXUnit.value = 0;
        }
...
//------------------------------------------------------------------------------------------------------------------
    ...
    MappingPropertyDescriptor { id: topDeckFocused; path: propertiesPath + ".top_deck_focus"; type: MappingPropertyDescriptor.Boolean; value: true;
        onValueChanged: {
            focusedDeckId = value ? topDeckId : bottomDeckId
            unfocusedDeckId = !value ? topDeckId : bottomDeckId
...
//------------------------------------------------------------------------------------------------------------------
    ...
    MappingPropertyDescriptor { id: editMode; path: propertiesPath + ".beatgrid.edit"; type: MappingPropertyDescriptor.Integer; value: EditMode.disabled;
        onValueChanged: {
    ...
    MappingPropertyDescriptor { id: zoomedEditView; path: propertiesPath + ".beatgrid.edit.zoomed"; type: MappingPropertyDescriptor.Boolean; value: false
        onValueChanged: {
    ...
    MappingPropertyDescriptor { path: propertiesPath + ".beatgrid.edit.position"; type: MappingPropertyDescriptor.Float; value: 0.0 }
    MappingPropertyDescriptor { path: propertiesPath + ".beatgrid.scan.offset"; type: MappingPropertyDescriptor.Integer; value: 0 }
    MappingPropertyDescriptor { id: beatsXscan; path: propertiesPath + ".beatgrid.scan.beats"; type: MappingPropertyDescriptor.Integer; value: 0 }
    MappingPropertyDescriptor { id: scan; path: propertiesPath + ".beatgrid.scan.update"; type: MappingPropertyDescriptor.Boolean; value: false }
