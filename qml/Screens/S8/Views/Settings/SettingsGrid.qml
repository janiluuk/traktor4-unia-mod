...
//------------------------------------------------------------------------------------------------------------------
    ...
    property var settings: ({
        hardware: {
            ...
            touchstrip: {
                // mode: touchstripMode.value,
                bend_nudge: {
                    sensivity: bendSensitivity.value,
                    direction: bendDirection.value, //FIX
                },
                scratch: {
                    sensivity: scratchSensitivity.value,
                    direction: scratchDirection.value,
                }
            },
            buttons: {
                /*
                ...
                */
                ...
                fx_select: isTraktorD2 || isTraktorS8 ? {
                    modes: {
                        default: fxSelectButton.value,
                        shift: shiftFxSelectButton.value,
                    },
                } : undefined,
                hotcue: isTraktorS5 ? {
                    modes: {
                ...
                loop: isTraktorD2 || isTraktorS8 ? {
                    modes: {
                        default: loopButton.value,
                        shift: shiftLoopButton.value,
                    },
                } : undefined,
                freeze: isTraktorD2 || isTraktorS8 ? {
                    modes: {
                        default: freezeButton.value,
                        shift: shiftFreezeButton.value,
                    },
                } : undefined,
                d2_buttons: isTraktorD2 ? {
                    modes: {
                        default: d2buttons.value,
                    },
                } : undefined,
            },
            encoders: {
                ...
                loop: {
                    ...
                    turn: {
                        // default: loopEncoder.value,
                        // shift: shiftLoopEncoder.value,
                    },
                },
            },
            faders: {
        ...
        display: {
            theme: {
                ...
                supreme: {
                    ...
                    // use_default_loop_widget: useDefaultLoopWidget.value,
                }
            },
            general: {
                key: {
            ...
            browser: {
                behavior: {
                    ...
                    related_screens: isTraktorD2 ? undefined : independentScreenBrowser.value,
                    guides: {
                        bpm: {
        ...
        others: {
            hardware: {
                ...
                midi_settings: {
                    use_midi: useMIDIControls.value,
                },
                vinyl_break: {
                ...
                stem_controls: {
                    reset_on_load: stemResetOnLoad.value,
                },
            },
            timers: {
    ...
    */
    ...
    function exportSettings(){
        // Settings.exportSettings(root.value, settings, screen.flavor.description)
        switch (true) {
            case isTraktorS5:
                Settings.exportSettings(root.value, settings, "s5")
                break;
            case isTraktorS8:
    ...
    function importSettings(){
        // Settings.importSettings(root.value, settings, screen.flavor.description)
        switch (true) {
            case isTraktorS5:
                Settings.importSettings(root.value, "s5").catch((error) => {
